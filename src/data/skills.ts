...
export interface SkillCategory {
    ...
    taglineEn: string;
    icon: string;
    accent: string; // hex used for glows / borders per panel
    skills: Skill[];
}
...
export const skillCategories: SkillCategory[] = [
    {
        ...
        tagline: 'Desarrollo agéntico diario: Claude Code en el centro del workflow.',
        taglineEn: 'Daily agentic development: Claude Code at the core of the workflow.',
        icon: '<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="#D97757" d="M12 1.5l1.91 6.16a2 2 0 0 0 1.32 1.32l6.16 1.91a1.16 1.16 0 0 1 0 2.22l-6.16 1.91a2 2 0 0 0-1.32 1.32L12 22.5a1.16 1.16 0 0 1-2.22 0l-1.91-6.16a2 2 0 0 0-1.32-1.32L.39 13.11a1.16 1.16 0 0 1 0-2.22l6.16-1.91a2 2 0 0 0 1.32-1.32L9.78 1.5a1.16 1.16 0 0 1 2.22 0Z"/></svg>',
        accent: '#D97757',
        skills: [
            { name: 'Claude Code', level: 'expert' },
            { name: 'Agent Skills', level: 'advanced' },
            { name: 'MCP (Model Context Protocol)', level: 'advanced' },
            { name: 'Subagentes & Workflows', level: 'advanced' },
            { name: 'Claude API', level: 'advanced' },
            { name: 'Context Engineering', level: 'advanced' },
    ...
    },
    {
        ...
        tagline: 'Interfaces rápidas, accesibles y con animación de nivel producto.',
        taglineEn: 'Fast, accessible interfaces with product-grade animation.',
    ...
    },
    {
        ...
        tagline: 'Supabase y PostgreSQL como columna vertebral de producto.',
        taglineEn: 'Supabase and PostgreSQL as the product backbone.',
        ...
        skills: [
            ...
            { name: 'RLS (Row Level Security)', level: 'advanced' },
    ...
    },
    {
        ...
        tagline: 'Pipelines que trabajan solos: webhooks, colas y deploys.',
        taglineEn: 'Pipelines that work on their own: webhooks, queues and deploys.',
    ...
    },
    {
        ...
        title: 'Desktop & JVM',
        titleEn: 'Desktop & JVM',
        tagline: 'Apps de escritorio reales con Kotlin y Compose.',
        taglineEn: 'Real desktop apps with Kotlin and Compose.',
