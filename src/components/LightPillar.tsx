...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    // Keep canvas synced with container size (works for viewport + layout changes)
    ...
    const scheduleSync = () => {
      ...
      resizeTimeout = window.setTimeout(syncRendererSize, 80);
    };
    ...
    // Initial post-layout sync in case first paint dimensions are still settling
