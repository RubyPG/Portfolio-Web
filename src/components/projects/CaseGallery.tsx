...
const CaseGallery = ({
  ...
  useEffect(() => {
    if (typeof window === 'undefined' || lightboxIndex === null || items.length < 2) {
      return;
    }
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {lightboxIndex !== null ? (
          <motion.div
            className="fixed inset-0 z-[70] flex items-center justify-center bg-black/86 p-4 backdrop-blur-md"
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-6xl overflow-hidden rounded-[1.75rem] border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,18,0.98),rgba(10,10,10,0.92))] shadow-[0_28px_120px_rgba(0,0,0,0.55)]"
              initial={
                reduceMotion
                  ? { opacity: 1 }
            ...
            >
              <div className="absolute left-4 top-4 z-20 flex gap-2">
                <span className="rounded-full border border-white/12 bg-black/60 px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-accent">
                  {items[lightboxIndex].label ?? 'Vista ampliada'}
                </span>
              ...
              <div className="grid gap-0 lg:grid-cols-[minmax(0,1.2fr)_360px]">
                <div className="relative overflow-hidden bg-black/35">
                  <div className="absolute inset-x-0 top-0 z-10 h-24 bg-[linear-gradient(180deg,rgba(0,0,0,0.36),transparent)]" />
                  ...
                  <div className="aspect-[16/10] lg:aspect-auto lg:min-h-[640px]">
                    <AnimatePresence mode="wait">
                      <motion.img
                        key={items[lightboxIndex].image}
                ...
                <div className="flex flex-col justify-between border-t border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.015))] p-5 lg:border-l lg:border-t-0 lg:p-6">
                  <div>
                    <p className="text-[0.68rem] font-semibold uppercase tracking-[0.28em] text-secondary/78">
                      Captura activa
                    </p>
                    ...
                    {items.map((item, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            'flex w-full items-center gap-3 rounded-[1rem] border px-3 py-2 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70',
                            isCurrent
